...
class TabAdmin1(QWidget):
    ...
    def upload_file(self):
        ...
        if file_dialog.exec() == QFileDialog.DialogCode.Accepted:
            # Получение выбранных файлов и добавление их в базу данных

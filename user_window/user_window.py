from PyQt6.QtWidgets import QMainWindow, QTabWidget, QPushButton, QWidget
import sqlite3
from user_window.tab_user1 import TabUser1
...
class UserWindow(QMainWindow):
    def __init__(self, username, access_level, auth_window):
        ...
        self.tab1 = TabUser1(username, access_level)
        self.tab3 = TabAdmin2(username)
